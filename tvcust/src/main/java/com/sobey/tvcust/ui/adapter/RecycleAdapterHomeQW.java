...
public class RecycleAdapterHomeQW extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private int src;
    private List<TestEntity> results;

    public RecycleAdapterHomeQW(Context context,int src, List<TestEntity> results) {
